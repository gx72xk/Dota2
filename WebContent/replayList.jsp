...
<%
	...
	List<Replay> replays = dao.findAllReplays();
%>
=======
<body>
...
=======
			...
			<li class="active"><a href="http://localhost:8080/DotAHOT/replayList.jsp">Replays</a></li>
...
<<<<<<< HEAD
			...
			%>
				<tr>
					<td><a href="http://localhost:8080/DotaRocks/ReplayAction?replayId=<%= replay.getId() %>&flag=0"><%= replay.getTitle() %></a></td>
					<td><%= replay.getUsername() %></td>
