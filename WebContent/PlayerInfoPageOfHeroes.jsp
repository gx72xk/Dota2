...
<body>
	...
	<div style="margin: 0px 40px 0px 40px">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="http://localhost:8080/DotAHOT/PlayerInfoPageOfHeroes.jsp">Heros</a></li>
	...
	<div class="panel panel-primary" style="margin: 0px 40px 0px 40px;">
		<div class="panel-heading">
			<h3 class="panel-title">Hero Stats</h3>
		</div>
		<table class="table">
			<th>Hero</th>
			<th>Played times</th>
	...
	<div class="panel panel-primary" style="margin: 0px 40px 0px 40px;">
		<div class="panel-heading">
			<h3 class="panel-title">Unused Heroes</h3>
			<tr>
				<td></td>
			</tr>
		</div>
