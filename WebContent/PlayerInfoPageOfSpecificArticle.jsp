...
<title>Player Info Of Specific Article</title>
</head>
...
<%
	...
	article = articleDao.findArticleById(Globals.articleId);
	...
	if("addLike".equals(action)){
		articleDao.addLikeNum(article.getId());
		...
		if(Globals.username != null){
			...
			User loginUser = userDao.findUserByUsername(Globals.username);
...
<<<<<<< HEAD
			...
			<li class="active"><a href="http://localhost:8080/DotaRocks/PlayerInfoPageOfArticles.jsp">Articles</a></li>
	...
	<form>
		<div class="panel panel-primary" style="margin: 0px 40px 0px 40px">
			<div class="panel-heading">
				<h3 align="center" style="font-size:40px;font-weight: bold ;color:#CCCC66;font-family:Segoe Print"><%= article.getTitle() %></h3>
			</div>
...
=======
	...
	<div class="panel panel-primary" style="margin: 20px 40px 0px 40px">
		...
		<div class="panel panel-default">
			...
			<ul class="list-group">
				<li class="list-group-item"><p class="text-right">Commenter ID  Date</p></li>
			</ul>
		</div>
>>>>>>> 621d5db566ffd76d342f2d41a5254b8f2f591ae7
	</div>
...
=======
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form">
					<div class="form-group">
						<textarea class="form-control" placeholder="Comment Title" rows="5"></textarea>
					</div>
				</form>
				<div align="right">
